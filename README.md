#General Overview : Script setgit.sh ensures how users in a group can share, modify, read, write and access data from files created with inheritance from parent-groups directory ownership.
